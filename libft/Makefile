...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/03/20 16:12:04 by kkostrub          #+#    #+#              #
#    Updated: 2018/03/20 16:12:10 by kkostrub         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c \
	...
	ft_strlcat.c ft_strncat.c ft_strchr.c ft_strrchr.c \
	...
	ft_lstiter.c ft_lstmap.c ft_swap.c ft_realloc.c \
	ft_sqrt.c ft_sort_int_tab.c ft_is_sort.c
